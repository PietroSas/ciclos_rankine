...
import com.pietrosales.ciclos_rankine.Saidas.SaidasReaquecido;

public class TelaResultadosReaquecido extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_tela_resultados_reaquecido);
                ...
                if (preenchido == Boolean.TRUE) {
                    if (Float.valueOf(p_alta) >= Float.valueOf(p_intermediaria)) {
                        ...
                        if (Float.valueOf(p_intermediaria) >= Float.valueOf(p_baixa)) {
                            ...
                            Intent intent = new Intent(TelaResultadosReaquecido.this, SaidasReaquecido.class);
                            ...
                            Toast.makeText(TelaResultadosReaquecido.this, "Pressão intermediária deve ser maior ou igual à pressão inferior", Toast.LENGTH_SHORT).show();
                        }
                    } else {
                        Toast.makeText(TelaResultadosReaquecido.this, "Pressão superior deve ser maior ou igual à pressão intermediária", Toast.LENGTH_SHORT).show();
                    }

                } else {
                    Toast.makeText(TelaResultadosReaquecido.this, "Preencha todos os campos!", Toast.LENGTH_SHORT).show();
                }
            }
        });
